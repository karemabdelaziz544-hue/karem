...
import DoctorLayout from './layouts/DoctorLayout'; // الملف اللي لسه عاملينه
...
const AppContent: React.FC = () => {
  ...
  const hideHeaderFooter = ['/dashboard', '/login', '/signup', '/admin', '/doctor-dashboard'].some(path => location.pathname.startsWith(path));
